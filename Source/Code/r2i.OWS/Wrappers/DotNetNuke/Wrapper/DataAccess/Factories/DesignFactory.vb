        ...
        Private Function ExportModule(ByRef Mi As IModuleInfo) As String
            ...
            If Not objModule Is Nothing Then
                If objModule.BusinessControllerClass <> "" And objModule.IsPortable Then
                    Try
                        Dim objObject As Object = DotNetNuke.Framework.Reflection.CreateObject(objModule.BusinessControllerClass, objModule.BusinessControllerClass)
                        ...
                        If TypeOf objObject Is DotNetNuke.Entities.Modules.IPortable Then
                            ...
                            If Content <> "" Then
                                ...
                                Content = "<?xml version=""1.0"" encoding=""utf-8"" ?>" & _
                                  "<content type=""" & CleanName(objModule.FriendlyName) & """ version=""" & objModule.Version & """>" & _
                                  Content & _
                                  "</content>"
                            End If
                            Return Content
                ...
                If objModule.BusinessControllerClass <> "" And objModule.IsPortable Then
                    Try
                        ...
                        If TypeOf objObject Is DotNetNuke.Entities.Modules.IPortable Then
                            ...
                            If strType = CleanName(objModule.FriendlyName) Or strType = CleanName(objModule.FriendlyName) Then
